"""Native cognis-connect emit for githubrecon — forward findings to any platform.

Maps githubrecon's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    githubrecon ... --format json | githubrecon-emit --to stix
    githubrecon-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
