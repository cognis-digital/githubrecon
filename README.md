...
[![PyPI](https://img.shields.io/pypi/v/cognis-githubrecon.svg)](https://pypi.org/project/cognis-githubrecon/)
[![CI](https://github.com/cognis-digital/githubrecon/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/githubrecon/actions)
...
GITHUBRECON exists for one job — map a github user/org footprint & leaked-secret surface from api exports — and does it without a SaaS bill or heavyweight setup.
...
```bash
githubrecon --version
githubrecon scan .                      # scan the current project
githubrecon scan . --format json
githubrecon scan . --fail-on high       # non-zero exit for CI gates
githubrecon mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **gitrob**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`githubrecon` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
